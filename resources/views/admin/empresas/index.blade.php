            ...
            <div class="bg-white dark:bg-gray-800 overflow-hidden shadow-xl sm:rounded-lg p-6 lg:p-8">
                <div class="bg-white dark:bg-gray-800 border-b border-gray-200 dark:border-gray-700">
                    <div class="mb-4 flex items-center justify-between">
                        <!-- Botón para crear empresas -->
                        <a href="{{ route('admin.users.create') }}" class="bg-cyan-500 dark:bg-cyan-700 hover:bg-cyan-600 dark:hover:bg-cyan-800 text-white font-bold py-2 px-4 rounded">Crear Empresa</a>
                        ...
                        <div>
                            ...
                            @else
                                <span class="text-gray-500">No hay empresas pendientes de aprobación</span>
                            @endif
                        </div>
                    </div>
                    ...
                    <table class="table-auto w-full">
                        <thead>
                            <tr>
                                ...
                                <th class="px-4 py-2 text-gray-900 dark:text-white text-center">RUC</th>
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td class="border px-4 py-2 text-gray-900 dark:text-white text-center">{{ $user->ruc }}</td>
                                <td class="border px-4 py-2 text-gray-900 dark:text-white text-center">{{ $user->email }}</td>
                                <td class="border px-4 py-2 text-center">{{ $user->getRoleName() }}</td>
